...
namespace SpreadsheetUtilitiesTest
{
    /// <summary>
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        ///Non-empty graph contains something also tests size
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///Slight variant checks duplicates
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///Nonempty graph should contain something test get dependents and get dependees
        ///</summary>
        [TestMethod()]
        ...
        //Test Edge cases
        /// <summary>
        /// Tests what happens when null is inputed
        /// </summary>
        [TestMethod()]
        public void TestNull()
        {
            ...
            //checks that null is not added by size
            Assert.AreEqual(0, t.Size);

            //checks that null is not added by dependee
            Assert.AreEqual(0, t.Size);

            //checks that null is not added by dependent
            Assert.AreEqual(0, t.Size);
